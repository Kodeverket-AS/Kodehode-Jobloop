    ...
    <>
      ...
      <div className="flex flex-col pt-0 pb-10 md:flex-row md:py-10">
        <div className="flex flex-row">
          <div className="flex flex-col items-center mx-9 w-14 md:mr-12 md:w-48">
          ...
          <div className="flex flex-col items-center mx-9 w-14 md:mx-12 md:w-48">
        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col items-center mx-9 w-14 md:ml-12 md:w-48">
