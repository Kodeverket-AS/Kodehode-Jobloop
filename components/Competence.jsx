  ...
  return (
    <>
      <div className="px-8 pt-20 pb-10 md:w-screen sm:px-10 md:px-12 lg:px-24">
        <h2 className="mx-auto md:pb-10 md:w-[42rem] lg:w-[45rem] text-center lg:text-left">
          {content1.title}
        </h2>
      ...
      <div className="flex flex-col w-full px-8 pt-0 pb-20 md:flex-row md:pt-10 md:pb-20 md:w-screen sm:px-10 md:px-12 md:justify-between lg:px-24 xl:px-0 lg:gap-16 xl:gap-32 xl:max-w-[1088px]">
        <div className="flex flex-row justify-between mb-5 md:mb-0 md:justify-evenly md:w-1/2 lg:gap-16 xl:gap-32">
          <div className="flex flex-col items-center w-24 mr-2 md:items-start md:mr-0 md:w-36 2xs:w-28 xs:w-32 sm:w-56 lg:w-40 xl:w-44">
            <Image
              ...
              alt={content2[0].alt || ""}
            />
            <h3 className="text-center md:text-left">{content2[0].title}</h3>
            <p className="hidden sm:block">{content2[0].content}</p>
          </div>
          <div className="flex flex-col items-center w-24 ml-2 md:items-start md:mx-0 md:w-36 2xs:w-28 xs:w-32 sm:w-56 lg:w-40 xl:w-44">
            <Image
              src={content2[1].logo}
              width={300}
              height={300}
              ...
              alt={content2[1].alt || ""}
            />
            <h3 className="text-center md:text-left">{content2[1].title}</h3>
        ...
        <div className="flex flex-row justify-between md:justify-evenly md:w-1/2 lg:gap-16 xl:gap-32">
          <div className="flex flex-col items-center w-24 mr-2 md:items-start md:mx-0 md:w-36 2xs:w-28 xs:w-32 sm:w-56 lg:w-40 xl:w-44">
            <Image
              src={content2[2].logo}
              width={300}
              height={300}
              ...
              alt={content2[2].alt || ""}
            />
            <h3 className="text-center md:text-left">{content2[2].title}</h3>
            <p className="hidden sm:block">{content2[2].content}</p>
          </div>
          <div className="flex flex-col items-center w-24 ml-2 md:items-start md:ml-0 md:w-36 2xs:w-28 xs:w-32 sm:w-56 lg:w-40 xl:w-44">
            <Image
              src={content2[3].logo}
              width={300}
              height={300}
              ...
              alt={content2[3].alt || ""}
            />
            <h3 className="text-center md:text-left">{content2[3].title}</h3>
