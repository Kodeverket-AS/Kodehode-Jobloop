  ...
  return (
    <section className="w-screen py-12">
      {content && content.length !== 0 ? (
        <div className="flex flex-col items-center gap-4 justify-center max-w-screen-2xl mx-auto px-2">
          <h2 className="text-center  border-b-4 border-jobloop-primary-orange w-fit pb-4">
            {title}
          </h2>

          <div className="flex flex-col gap-8 md:flex-row pb-8 justify-center m-auto pt-12 ">
