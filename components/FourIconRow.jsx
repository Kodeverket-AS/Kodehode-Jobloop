    ...
    <div className="flex flex-col items-center w-full p-8 text-center text-white bg-jobloop-primary-green sm:p-10 md:p-12 md:w-screen lg:p-24">
      ...
      <div className="flex flex-col w-full md:flex-row md:justify-center">
        <div className="flex flex-row justify-between mb-5 md:mb-0">
          <div className="flex flex-col items-start mr-5 w-28 md:mr-3 md:w-36 2xs:w-32 xs:w-36 sm:w-56 md:mx-0 lg:mr-7 lg:w-40 xl:mr-10 xl:w-44">
            <Image
              src={content[0].logo}
              width={300}
              height={300}
          ...
          <div className="flex flex-col items-start ml-5 w-28 md:mx-3 md:w-36 2xs:w-32 xs:w-36 sm:w-56 lg:mx-7 lg:w-40 xl:mx-10 xl:w-44">
            <Image
              src={content[1].logo}
              width={300}
              height={300}
        ...
        <div className="flex flex-row justify-between">
          <div className="flex flex-col items-start mr-5 w-28 md:mx-3 md:w-36 2xs:w-32 xs:w-36 sm:w-56 lg:mx-7 lg:w-40 xl:mx-10 xl:w-44">
            <Image
              src={content[2].logo}
              width={300}
              height={300}
          ...
          <div className="flex flex-col items-start ml-5 w-28 md:ml-3 md:w-36 2xs:w-32 xs:w-36 sm:w-56 md:mx-0 lg:ml-7 lg:w-40 xl:ml-10 xl:w-44">
            <Image
              src={content[3].logo}
              width={300}
              height={300}
