      ...
      <div className="pt-0 pb-10 md:justify-between md:w-full md:flex lg:max-w-[832px]">
        <div className="flex flex-row w-full pb-10 mx-auto md:flex-col md:w-28 md:pb-0 md:mx-0 lg:w-36">
          <div className="w-1/2 pr-3 md:mb-2 md:h-[150px] md:w-full h-[170px] md:pr-0">
            <Image
              src={urlFor(content[0].image).width(300).height(300).url()}
              width={300}
              height={300}
        ...
        <div className="flex flex-row w-full pb-10 mx-auto md:flex-col md:w-28 md:pb-0 md:mx-0 lg:w-36">
          <div className="w-1/2 pr-3 md:mb-2 md:h-[150px] md:w-full h-[170px] md:pr-0">
            <Image
              src={urlFor(content[1].image).width(300).height(300).url()}
              width={300}
              height={300}
        ...
        <div className="flex flex-row w-full pb-10 mx-auto md:flex-col md:w-28 md:pb-0 md:mx-0 lg:w-36">
          <div className="w-1/2 pr-3 md:mb-2 md:h-[150px] md:w-full h-[170px] md:pr-0">
            <Image
              src={urlFor(content[2].image).width(300).height(300).url()}
              width={300}
              height={300}
              className="object-cover w-full h-full border border-white rounded"
              alt={content[2].alt || ""}
        ...
        <div className="flex flex-row w-full pb-10 mx-auto md:flex-col md:w-28 md:pb-0 md:mx-0 lg:w-36">
          <div className="w-1/2 pr-3 md:mb-2 md:h-[150px] md:w-full h-[170px] md:pr-0">
            <Image
              src={urlFor(content[3].image).width(300).height(300).url()}
              width={300}
              height={300}
              className="object-cover w-full h-full border border-white rounded"
              alt={content[3].alt || ""}
