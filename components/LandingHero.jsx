        ...
        <>
            <div className='absolute top-0 block w-full -z-10 md:hidden'>
                ...
                <div className='absolute z-50 p-8 bg-kv-white top-60 rounded-t-3xl 2xs:top-60 xs:top-[16.5rem] sm:top-[19rem] sm:p-10'>
                    <p>
                        Vi rekrutterer kandidater som av ulike grunner har
                        havnet utenfor arbeidslivet og lærer dem opp til å bli
                        frontend-utviklere. Gjennom en kombinasjon av teoretisk
                        opplæring og praksis vil kandidatene lære seg de
                        viktigste teknologiene og bli klar for en karriere innen
                        utvikling.
                    </p>
                </div>
            </div>
            ...
            <div className='flex-col hidden w-screen gap-36 pt-32 pb-0 md:flex lg:pt-36 2xl:pt-72 '>
