  ...
  return (
    <div className="flex flex-col items-center w-full py-10 bg-jobloop-orange">
      ...
      <div className="pt-0 pb-10 md:flex">
        <div className="flex flex-row justify-center pb-10 mx-auto w-52 md:mr-12 md:w-48 md:pb-0">
          <Image
            src={content[1].image}
            width={300}
            height={300}
            className="w-1/2 mb-2 rounded"
          />
        ...
        <div className="flex flex-row justify-center pb-10 mx-auto md:pb-0 w-52 md:mx-12 md:w-48">
          <Image
            src={content[0].image}
            width={300}
            height={300}
        ...
        <div className="flex flex-row justify-center pb-10 mx-auto w-52 md:mx-12 md:w-48 md:pb-0">
          <Image
            src={content[3].image}
            width={300}
            height={300}
        ...
        <div className="flex flex-row justify-center mx-auto w-52 md:ml-12 md:w-48">
          <Image
            src={content[2].image}
            width={300}
            height={300}
